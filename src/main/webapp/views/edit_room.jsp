          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="${pageContext.request.contextPath}/views/edit_room.jsp">Edit Room </a>
                </li>   
              </ul>
            </div>
            <br>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Edit Room Data </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                     ...
                     <%String roonid=request.getParameter("room_id"); %>
                     <input type="hidden" name="action" value="update">
                     <input type="hidden" name="room_id" value="<%=roonid%>">
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          <label for="largeInput">Enter Room Name</label>
                          <input
                            type="text"
                            class="form-control form-control-lg"
                            id="largeInput"
