    ...
    <!--          <span class="sub-item">Level 1</span>
      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Edit Subjects...</h3>
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="${pageContext.request.contextPath}/views/edit_subject.jsp">Edit Subject </a>
                </li>   
              </ul>
            </div>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Edit Subject Data </div>
                  </div>
    	...
    	int subid=Integer.parseInt(request.getParameter("sub_id"));
                      ...
                      Subject s = DAOFactory.getSubjectDao().getSubjectById(subid);

     
             
              	%>
                      <form action="${pageContext.request.contextPath}/EditSubjectServlet" method="post">
                     ...
                     <input type="hidden" name="sub_id" value="<%=subid%>">
                      ...
                      Faculty f = DAOFactory.getFacultyDao().getFacultyById(s.getFac_id());

              	%>
              	 <option value="<%= f.getFac_id() %>"><%= f.getUsername() %></option>
                            <option value=""></option>
